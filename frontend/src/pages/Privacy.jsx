      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-lg mb-4">
            At KGN Jewellery, we are committed to protecting the privacy and security of our users' personal information. This Privacy Policy outlines how we collect, use, and safeguard the information you provide to us when using our website and services.
          </p>
          <h2 className="text-2xl font-semibold mb-4">Information We Collect</h2>
          <p className="text-lg mb-4">
            When you sign in to KGN Jewellery using Google OAuth, we collect basic profile information provided by your Google account, including your name and email address. We may also collect information related to your activity on our platform, such as the sports equipment you browse or purchase.
          </p>
          ...
          <p className="text-lg">
            If you have any questions or concerns about our Privacy Policy or the use of your personal information, please contact us at privacy@kgnjewellery.com.
          </p>
        </div>
      </div>
    </>
