    ...
    <div className='flex py-5'><Link to='/'><FaHome className='h-6 w-6 m-5'/></Link><h1 className='text-4xl font-bold mx-auto my-auto'>Silverwale</h1></div><hr/>
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg mb-4">
            When you sign in to Silverwale using Google OAuth, we collect basic profile information provided by your Google account, including your name and email address. We may also collect information related to your activity on our platform, such as the jewellery you browse or purchase.
          </p>
          ...
          <p className="text-lg">
            If you have any questions or concerns about our Privacy Policy or the use of your personal information, please contact us at privacy@silverwale.com.
          </p>
        </div>
      </div>
    </>
