                        ...
                        <div className="mt-2 grid grid-cols-2 md:grid-cols-4 gap-2">
                            {formData.images.map((file, idx) => (
                                <button
                                    ...
                                    className={`border rounded overflow-hidden relative ${formData.coverImageIndex === idx ? 'ring-2 ring-blue-600' : ''}`}
                                >
                                    <img
                        ...
                        <tr key={key}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                {(() => {
                                    ...
                                    const src = product.image && product.image[coverIdx] ? `/${product.image[coverIdx]}` : '';
                                    return <img src={src} alt="No" className="w-22 h-20 object-cover" />;
                                })()}
                            </td>
